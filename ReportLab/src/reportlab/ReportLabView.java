 ...
 */
public class ReportLabView extends FrameView {
    
    public ReportLabView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        reportlab.Datos d = new reportlab.Datos();
    ...
    public void deleteRecord() {
        ...
        List<reportlab.Datos> toRemove = new ArrayList<reportlab.Datos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            reportlab.Datos d = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(d);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<reportlab.Datos> merged = new ArrayList<reportlab.Datos>(list.size());
                for (reportlab.Datos d : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ReportLabApp.getApplication().getMainFrame();
            aboutBox = new ReportLabAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ReportLabApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(reportlab.ReportLabApp.class).getContext().getResourceMap(ReportLabView.class);
        ...
        apellidosLabel.setText(resourceMap.getString("apellidosLabel.text")); // NOI18N
        apellidosLabel.setName("apellidosLabel"); // NOI18N

        domicilioLabel.setText(resourceMap.getString("domicilioLabel.text")); // NOI18N
        domicilioLabel.setName("domicilioLabel"); // NOI18N

        grupoLabel.setText(resourceMap.getString("grupoLabel.text")); // NOI18N
        ...
        apellidosField.setName("apellidosField"); // NOI18N
        ...
        grupoField.setName("grupoField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.grupo}"), grupoField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), grupoField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(reportlab.ReportLabApp.class).getContext().getActionMap(ReportLabView.class, this);
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(grupoField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)))
    ...
    private java.util.List<reportlab.Datos> list;
